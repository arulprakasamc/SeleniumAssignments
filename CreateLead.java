...
public class CreateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Arulprakasam");
		
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Chinnadurai");
		...
		driver.findElement(By.id("createLeadForm_generalToName")).sendKeys("Arulprakasam");
		
		driver.findElement(By.id("createLeadForm_generalAttnName")).sendKeys("Arul");
